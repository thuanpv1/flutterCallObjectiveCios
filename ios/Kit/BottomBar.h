...
-(UIButton*)addBarButton:(NSString*)name
             normalImage:(nullable NSString*)normal
           selectedImage:(nullable NSString*)selected
           disabledImage:(nullable NSString*)disabled
              autoSelect:(BOOL)autoSelect
              atPosition:(BottomBarPosition)position;
-(UIButton*)addBarButton:(NSString*)name
                    size:(CGSize)size
             normalImage:(nullable NSString*)normal
           selectedImage:(nullable NSString*)selected
