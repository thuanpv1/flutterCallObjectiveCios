...
#define MIN_MSEC_TIMESTAMP 31507200000 // Minimum millisecond timestamp
#define MAX_MSEC_TIMESTAMP 4687730032000 // The maximum time stamp in milliseconds
#define IS_MSEC(timestamp) (MIN_MSEC_TIMESTAMP < timestamp && timestamp < MAX_MSEC_TIMESTAMP)

#define MIN_SEC_TIMESTAMP 31507200 // Minimum time stamp in seconds
#define MAX_SEC_TIMESTAMP 4670409600 // Maximum value of timestamp in seconds
#define IS_SEC(timestamp)   (MIN_SEC_TIMESTAMP < timestamp && timestamp  < MAX_SEC_TIMESTAMP)

#define AnchorSize(view,size) \
